...
- [BASmatlab](https://github.com/jywang2016/BASmatlab); matlab工具箱。目前收录有BAS/BSAS/BSO算法。
...
- Obstacle Avoidance and Tracking Control of Redundant Robotic Manipulator: An RNN based
Metaheuristic Approach(已被ieee transactions on industrial informatics录用)
