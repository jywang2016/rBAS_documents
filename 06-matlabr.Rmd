...
```{r,include=FALSE}
Rcpp::sourceCpp('D:/JYwang_HUST/R-blogger/C/Rcpptest.cpp')
```
...
```{r,include=FALSE}
Rcpp::sourceCpp('D:/JYwang_HUST/R-blogger/C/Rcppmich.cpp')
```
...
```{r,include=FALSE}
Rcpp::sourceCpp('D:/JYwang_HUST/R-blogger/C/RcppPV.cpp')
```
